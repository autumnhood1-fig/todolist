...
export const INITIAL_CONTAINERS: Container[] = [
  ...
  },
  {
    ...
    size: 'medium',
    items: [
      { id: 'dc-1', text: 'Clean ACs', subSteps: [], completed: false },
      { id: 'dc-2', text: 'Clean fans', subSteps: [], completed: false },
      { id: 'dc-3', text: 'Water plants', subSteps: [], completed: false },
      { id: 'dc-4', text: 'Strip beds', subSteps: [], completed: false },
      { id: 'dc-5', text: 'Upstairs trash', subSteps: [], completed: false },
      { id: 'dc-6', text: 'Litter(s)', subSteps: [], completed: false },
      { id: 'dc-7', text: 'Old pot on balcony', subSteps: [], completed: false },
    ],
  },
];
